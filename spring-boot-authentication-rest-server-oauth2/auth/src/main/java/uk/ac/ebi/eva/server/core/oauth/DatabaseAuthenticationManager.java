...
import uk.ac.ebi.eva.server.core.oauth.exceptions.AuthenticationNameNull;
import uk.ac.ebi.eva.server.core.utils.ConfiguredBCrypt;
import uk.ac.ebi.eva.server.persistence.dao.UserDao;
import uk.ac.ebi.eva.server.persistence.entities.Group;
import uk.ac.ebi.eva.server.persistence.entities.Role;
